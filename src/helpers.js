...
export const getNewUsername = (
  ...
  if (isInvalid) return [currentUsername, USERNAME_ERROR_STR, prevUsername];
  if (username in users) return [username, null, username];
  return [username, null, prevUsername];
};
